    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <a href="{{ route('competitions.index') }}" class="btn btn-primary btn-block">View All
                        Competitions</a>
                    <a href="{{ route('competitions.create') }}" class="btn btn-success btn-block">Add New
                        Competition</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <a href="{{ route('admin.general_requests.index') }}" class="btn btn-primary btn-block">View All
                        General Requests</a>
                </div>
            </div>
        </div>
